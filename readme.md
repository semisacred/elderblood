...
- **Elemental Affinity – Mastery**
  - Ignore draconic element resistance
  - Gain resistance to draconic element
  - Gain advantage on attacks against element-afflicted enemies
- **Fly**

### Level 14
- **Elemental Affinity – Wyrmsong**
  - Heal **1d4 HP** whenever you deal draconic element damage
